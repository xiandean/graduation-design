<?php /* Smarty version 2.6.29, created on 2016-03-15 00:33:12
         compiled from admin/m_edit.tpl */ ?>
<!DOCTYPE html>
 ...
 ?>
    <div class="rightpart">
        <div class="breadpiece">
            <a href="index.php">首页</a><span> > </span><a href="m_list.php">管理员列表</a><span> > </span><a class="on">编辑管理员：<?php echo $this->_tpl_vars['m']['name']; ?>
</a>
        </div>
        ...
        <form id="form" action="../common/uploadImg.php?type=headIcon" method="post"  enctype="multipart/form-data" target="frame">
                ...
                <form id="form2" method="post" action='ajaxApi/m_reset.php?id=<?php echo $this->_tpl_vars['m']['id']; ?>
'>
                    <div class="form-row clearfix">
                        <span class="tt"><em>*</em> 账户名</span>
                        <input type="text" name="name" disabled="false" class="ipt-text" placeholder="请输入账户名" value="<?php echo $this->_tpl_vars['m']['name']; ?>
">
                    </div>
                    ...
                    <div class="form-row clearfix">
                        ...
                        <div class="avatar">
                            <input type="hidden" name="imgpath" value="<?php echo $this->_tpl_vars['m']['img']; ?>
">
                            <img class="fl" id="msg" src="<?php if ($this->_tpl_vars['m']['img']): ?> <?php echo $this->_tpl_vars['m']['img']; ?>
 <?php else: ?> ../common/templates/images/detail_avatar.jpg <?php endif; ?>" alt="">
                    ...
                    <div class="form-row clearfix">
                        ...
                        <input type="text" name="phone" disabled="disabled" class="ipt-text" placeholder="" value="<?php echo $this->_tpl_vars['m']['phone']; ?>
">
                    </div>
                    <div class="form-row clearfix">
                        <span class="tt"><em>*</em> 邮箱</span>
                        <input type="text" name="email" disabled="disabled" class="ipt-text" placeholder="" value="<?php echo $this->_tpl_vars['m']['email']; ?>
">
                    </div>
                    <div class="form-row clearfix">
                        <span class="tt">所在地</span>
                        <input type="text" name="address" disabled="disabled" class="ipt-text" placeholder="广东  广州" value="<?php echo $this->_tpl_vars['m']['address']; ?>
">
                    </div>
                    ...
                    <?php if ($this->_tpl_vars['m']['id'] == $this->_tpl_vars['mid']): ?>
