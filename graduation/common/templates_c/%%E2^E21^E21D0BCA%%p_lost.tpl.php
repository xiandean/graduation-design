<?php /* Smarty version 2.6.29, created on 2016-03-15 00:27:59
         compiled from user/p_lost.tpl */ ?>
<!DOCTYPE html>
...
<div  class="step1" id="step1">
	<div class="sub-title">
        ...
        <ul>
            <li><span class="tt"><em>*</em>姓名</span><input type="text" name="u_name" value="<?php echo $this->_tpl_vars['userinfo']['name']; ?>
"/></li>       
            <li><span class="tt"><em>*</em>手机号码</span><input type="text" name="u_phone" value="<?php echo $this->_tpl_vars['userinfo']['phone']; ?>
"/></li>       
            <li><span class="tt">邮箱</span><input type="text" name="u_email" value="<?php echo $this->_tpl_vars['userinfo']['email']; ?>
"/></li>     
            <li><span class="tt"><em>*</em>联系地址</span><input type="text" name="u_address" value="<?php echo $this->_tpl_vars['userinfo']['address']; ?>
"/></li>         
