<?php /* Smarty version 2.6.29, created on 2016-03-14 22:31:57
         compiled from user/edit_lost.html */ ?>
<!DOCTYPE html>
...
" />
            ...
            <li><span class="tt"><em>*</em>物品特征</span><input type="text" name="l_feature" placeholder="如：黑色 皮质 女士钱包" value="<?php echo $this->_tpl_vars['lostinfo'][0]['l_feature']; ?>
" /></li> 
            <li ><span class="tt"><em>*</em>详情描述</span>
                <textarea name="l_desc" id="vision" placeholder="简要说明遗失的时间地点，以及失物重要特征"><?php echo $this->_tpl_vars['lostinfo'][0]['l_desc']; ?>
</textarea>
            </li> 
...
">
            ...
            <li><span class="tt"><em>*</em>丢失/拾获地点</span><input type="text" name="l_place" value="<?php echo $this->_tpl_vars['lostinfo'][0]['l_place']; ?>
" /></li>     
...
" /></li>  
        ...
        <ul>
            <li><span class="tt"><em>*</em>姓名</span><input type="text" name="u_name" value="<?php echo $this->_tpl_vars['lostinfo'][0]['u_name']; ?>
"/></li>       
            <li><span class="tt"><em>*</em>手机号码</span><input type="text" name="u_phone" value="<?php echo $this->_tpl_vars['lostinfo'][0]['u_phone']; ?>
" /></li>       
            <li><span class="tt"><em>*</em>邮箱</span><input type="text" name="u_email" value="<?php echo $this->_tpl_vars['lostinfo'][0]['u_email']; ?>
" /></li>     
            <li><span class="tt"><em>*</em>联系地址</span><input type="text" name="u_address" value="<?php echo $this->_tpl_vars['lostinfo'][0]['u_address']; ?>
" /></li>         
