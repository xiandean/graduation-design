<?php /* Smarty version 2.6.29, created on 2016-03-16 19:52:37
         compiled from admin/leave_list.tpl */ ?>
<!DOCTYPE html>
    ...
    <div class="rightpart">
        ...
        <form action="" method="get">
            ...
            <select id="select1">
                ...
                <option value="1" <?php if ($this->_tpl_vars['type'] == 1): ?>selected="selected"<?php endif; ?>>留言者</option>
                <option value="2" <?php if ($this->_tpl_vars['type'] == 2): ?>selected="selected"<?php endif; ?>>留言内容</option>
            </select> 
...
?>
                    <tr <?php if ($this->_sections['key']['index'] % 2 == 0): ?>class="hui"<?php endif; ?>>
                        ...
                        <td class="detail"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['content']; ?>
</td>
                        <td><input type="checkbox" name="l[]" data-mid="<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['id']; ?>
" /></td>
                    </tr>
                    <?php endfor; endif; ?>
