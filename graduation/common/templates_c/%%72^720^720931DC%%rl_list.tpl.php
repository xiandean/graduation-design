<?php /* Smarty version 2.6.29, created on 2016-03-14 22:25:52
...
" target="_blank"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['rl_uid']; ?>
</a></td>
                        <td><a href="u_edit.php?id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['u_id']; ?>
" target="_blank"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['u_id']; ?>
</a></td>
