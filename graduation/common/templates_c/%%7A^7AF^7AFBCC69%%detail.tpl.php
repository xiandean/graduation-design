<?php /* Smarty version 2.6.29, created on 2016-03-22 10:39:45
         compiled from user/detail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'user/detail.tpl', 29, false),)), $this); ?>
<!DOCTYPE html>
...
" /><input class="leave-submit" type="button" value="取消" id="cancle" /></div>
					...
					<li><input class="getintouch" type="button" id="torl" value="<?php if ($this->_tpl_vars['type'] == 'lost'): ?>联系归还<?php else: ?>联系认领<?php endif; ?>" /><input class="leave-submit" type="button" id="tosay" value="提供线索"/></li>
				</ul>
