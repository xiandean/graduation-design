<?php /* Smarty version 2.6.29, created on 2016-03-14 22:45:07
         compiled from user/list_found.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'smartTruncate', 'user/list_found.html', 109, false),)), $this); ?>
<!DOCTYPE html>
...
" />
        ...
        <form action="search.php" method="get">
            ...
            <select id="select1">
                ...
                <option value="3" selected="selected">招领启事</option>
            </select> 
...
<div class="section programs page-container"  style="height:auto;">
	<div class="wrapper clearfix">
        <div class="section-programs">
            <h1 class="title-bar title-bar2">招领启事</h1>  
            <div class="news-list">
...
?>
                    <li>
                        <a href="detail.php?type=found&l_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_id']; ?>
...
<?php else: ?>../common/templates/images/wutu.jpg<?php endif; ?>" alt=""></a>
                        <div class="programs-info">
                            <h2><span class="a-type1">[招领] </span><a href="detail.php?type=found&l_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_id']; ?>
" class="a-type1" target="_blank"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_name']; ?>
                            ...
                            <div class="vote"><a target="_blank" href="detail.php?type=found&l_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_id']; ?>
">查看详情</a></div>
                        </div>
                    </li>
                <?php endfor; endif; ?>
...
<script type="text/javascript" src="../common/templates/user/js/list_found.js"></script>
