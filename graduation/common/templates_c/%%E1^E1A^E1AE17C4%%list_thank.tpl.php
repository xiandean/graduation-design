<?php /* Smarty version 2.6.29, created on 2016-03-16 19:45:04
         compiled from user/list_thank.tpl */ ?>
<!DOCTYPE html>
...
?>
                    <li class="clearfix">
                        <div class="notes-info">
                            <h2><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['title']; ?>
</h2>
                            <p class="author">
								<span class="nickname"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['u_name']; ?>
</span>
