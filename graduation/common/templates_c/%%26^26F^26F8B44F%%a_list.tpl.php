<?php /* Smarty version 2.6.29, created on 2016-03-16 19:28:26
...
?>
                    <tr <?php if ($this->_sections['key']['index'] % 2 == 0): ?>class="hui"<?php endif; ?>>
                        <td style="text-align:left;"><span class="a-type1">[招领]</span><a href="l_edit.php?type=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['type']; ?>
&l_id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_id']; ?>
" target="_blank"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['l_name']; ?>
</a></td>
                        <td class="detail" style="text-align:left;"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['question']; ?>
</td>
