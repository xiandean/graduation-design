<?php /* Smarty version 2.6.29, created on 2016-03-16 19:28:40
         compiled from admin/n_list.tpl */ ?>
<!DOCTYPE html>
 ...
 ?>
    <div class="rightpart">
        <div class="breadpiece">
            <a href="index.php">首页</a><span> > </span><a class="on">公告列表</a>
        </div>
        ...
        <form action="" method="get">
            ...
            <select id="select1">
                ...
                <option value="1" <?php if ($this->_tpl_vars['type'] == 1): ?>selected="selected"<?php endif; ?>>标题</option>
                <option value="2" <?php if ($this->_tpl_vars['type'] == 2): ?>selected="selected"<?php endif; ?>>内容</option>
            </select> 
...
?>
                    <tr <?php if ($this->_sections['key']['index'] % 2 == 0): ?>class="hui"<?php endif; ?>>
                        <td><a href="n_edit.php?id=<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['a_id']; ?>
" target="_blank"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['title']; ?>
</a></td>
                        <td><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['p_date']; ?>
</td>
                        <td class="notecell"><?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['context']; ?>
</td>
                        <td><input type="checkbox" name="a[]" data-mid="<?php echo $this->_tpl_vars['page']['list'][$this->_sections['key']['index']]['a_id']; ?>
" /></td>
                    </tr>
                    <?php endfor; endif; ?>
            ...
            <div class="clearfix">
                ...
                <a class="edit" href="p_note.php" target="_blank">发布公告</a>
            </div>
        </div>
