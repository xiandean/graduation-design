        ...
        <div class="section-programs">
            ...
            <div class="news-list">
                ...
                {section name=key loop=$page.list}
                    <li>
                        <a href="detail.php?type=found&l_id={$page.list[key].l_id}" target="_blank"><img src="{if $page.list[key].l_img}{$page.list[key].l_img}{else}../common/templates/images/wutu.jpg{/if}" alt=""></a>
                        <div class="programs-info">
                            <h2><span class="a-type1">[招领] </span><a href="detail.php?type=found&l_id={$page.list[key].l_id}" class="a-type1" target="_blank">{$page.list[key].l_name}</a></h2>
                            <div class="author">
                            ...
                            <div class="vote"><a target="_blank" href="detail.php?type=found&l_id={$page.list[key].l_id}">查看详情</a></div>
                        </div>
                    </li>
                {/section}
                </ul>
