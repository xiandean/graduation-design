...
<div class="wrapper clearfix">
    ...
    <div class="rightpart">
        ...
        <div class="pub-wrap">
            ...
            <form  id="form" method="post" action="ajaxApi/reset_lost.php?type={$type}&l_id={$l_id}&u_id={$lostinfo[0].u_id}">
            <div  class="step1" id="step1">
                <div class="sub-title">
                    ...
                    <li class="list"><span class="tt"><em>*</em>启事类型</span>
                        ...
                        <li><span class="tt"><em>*</em>物品特征</span><input type="text" name="l_feature" placeholder="不超过15个字" value="{$lostinfo[0].l_feature}" /></li> 
                        <li ><span class="tt"><em>*</em>详情描述</span>
                            <textarea name="l_desc" id="vision" placeholder="建议160－200字，最多不超过260字">{$lostinfo[0].l_desc}</textarea>
                        </li> 
                        ...
                        <li><span class="tt"><em>*</em>丢失/拾获地点</span><input type="text" name="l_place" placeholder="不超过14个字" value="{$lostinfo[0].l_place}" /></li>     
                    ...
                    <ul>
                        <li><span class="tt"><em>*</em>姓名</span><input type="text" name="u_name" placeholder="不超过14个字" value="{$lostinfo[0].u_name}"/></li>       
                        <li><span class="tt"><em>*</em>手机号码</span><input type="text" name="u_phone" placeholder="不超过14个字" value="{$lostinfo[0].u_phone}" /></li>       
                        <li><span class="tt"><em>*</em>邮箱</span><input type="text" name="u_email" placeholder="不超过14个字" value="{$lostinfo[0].u_email}" /></li>     
                        <li><span class="tt"><em>*</em>联系地址</span><input type="text" name="u_address" placeholder="不超过14个字" value="{$lostinfo[0].u_address}" /></li>         
            ...
            <div class="step2" id="step2" style="display:none">
                ...
                <div class="person bg">
                    <ul>
                        ...
                        <li><span class="tt"><em>*</em>答案：</span><input type="text" name="answer[]" class="answer" value="{$lostinfo[key].answer}" placeholder="不超过14个字" /></li>  
                        <li class="list"><span class="tt"><em>*</em>答案验证模式</span>
