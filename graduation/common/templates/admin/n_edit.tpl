...
<div class="wrapper clearfix">
    ...
    <div class="rightpart">
        ...
        <form action="n_edit.php?id={$a.a_id}" method="post">
        <div class="note" style="padding-top:20px;">
            <div class="form-row clearfix">
                <span class="tt">标题</span>
                <input type="text" value="{$a.title}" name="title" class="title-text"/>
            </div>
            <div class="form-row clearfix">
                <span class="tt">内容</span>
                <textarea class="ipt-text" name="content">{$a.context}</textarea> 
            </div>
